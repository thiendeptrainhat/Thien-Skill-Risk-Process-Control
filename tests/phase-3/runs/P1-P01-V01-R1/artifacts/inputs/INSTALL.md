...
Hướng dẫn cho ba ZIP mục tiêu của bản `1.1.0`. Chỉ bắt đầu khi ZIP và checksum/version tương ứng có trong [RELEASE-MANIFEST.yaml](RELEASE-MANIFEST.yaml). Trạng thái nghiệm thu không được suy từ hướng dẫn này.
