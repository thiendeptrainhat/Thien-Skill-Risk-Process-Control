...
Trong cột module, `M01`–`M10` là mã module. Trong cột test hoặc bảng test,
...
| `XXXIX` | Runtime `SKILL.md` content | `M10` | `M09` | Concise router to ten modules; triggers/non-triggers/workflow/gates/QA/failure/output contract | `M01`–`M09` |
